(function (g) {
            ...
            if (g.isPlainObject(d)) w(d);
                ...
                if (o) {
                    ...
                    for (e = c.attributes.length - 1; 0 <= e; e--) {
                        ...
                        var j = c.attributes[e].nodeValue; - 1 !== f.indexOf(":") && (i.push({
                            name: f,
                            value: j
                        }), c.removeAttribute(f))
                    }
    ...
    var x = function (a, b) {
        ...
        u = "",
        u = "undefined" === typeof k.XMLSerializer ?
        new function () {
    ...
    h.ext.buttons.excelFlash = g.extend({}, t, {
        ...
        action: function (a, b, d, c) {
            ...
            var a = c._flash,
                ...
                j = b.buttons.exportData(c.exportOptions),
                k, l, h = function (a) {
                    k = e + 1;
                    l = n(f, "row", {
                        attr: {
